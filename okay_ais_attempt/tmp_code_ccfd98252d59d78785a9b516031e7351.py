...
# Function to apply a move to the current state and get the next state
...
# Example usage of the function with sample puzzles
...
fewest_moves_example  # Output the result